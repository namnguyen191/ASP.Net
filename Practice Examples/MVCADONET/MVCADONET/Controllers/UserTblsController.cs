...
namespace MVCADONET.Controllers
{
    public class UserTblsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Email")] UserTbl userTbl)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Email")] UserTbl userTbl)
        {
            if (ModelState.IsValid)
            {
